...
public class CourseEnrollment {
    ...
    public String getTheacherId() {return this.theacherId;}
    public void setTheacherId(String theacherId) {this.theacherId = theacherId;}

    public EnrollmentType getEnrollmentType() {return this.enrollmentType;}
    public void setEnrollmentType(EnrollmentType type) {this.enrollmentType = type;}
    ...
    public LocalDateTime getApprovedDate() {return this.approvedDate;}
