...
public class AdminController {
    ...
    public ResponseEntity<?> createEnrollmentSettings(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.OK).body("Configurazione creata con successo" + created);
    ...
    public ResponseEntity<?> getAllEnrollmentSettings(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.OK).body("Lista configurazioni recuperata con successo" + settings);
        } catch (Exception e) {
    ...
    public ResponseEntity<?> updateEnrollmentSettings(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.OK).body("Configurazione aggiornata con successo" + updated);
        } catch (IllegalArgumentException e) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getEnrollmentSettingsByCourse(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.OK).body("Configurazione recuperata con successo" + settings);
        } catch (Exception e) {
