...
public class TeacherController {
    ...
    public ResponseEntity<?> manualEnrollStudent(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED).body("Iscrizione confermata con successo\n" + enrollment);
    ...
    public ResponseEntity<?> bulkManualEnrollStudents(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED).body("Iscrizioni create con successo\n" + results);
        } catch (IllegalArgumentException e) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(e.getMessage());
        } catch (SecurityException e) {
            return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
