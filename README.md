...
|/api/v1/teachers/courses/{courseId}/enrollments|GET|getOwnCourseEnrollments()|Authorization, courseId: String|Header, Path Variable|List<CourseEnrollmentDTO>|Visualizza le iscrizioni ai corsi gestiti dal docente|
